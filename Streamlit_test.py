...
container.markdown(
    ...
    <div style="display: flex; align-items: center; justify-content: space-between;">
        <img src="{image}" style="width: 200px; margin-right: 10px; margin-bottom: 8px; margin-top: 20px;">
        <h1 style="color: #113f60; margin: 0;">La résidence secondaire à prix accessible trdddtd!</h1>
...
st.markdown(
 """
    <div style="height: 4px; background-color: #113f60;width: 100%; margin-top: 20px; margin-bottom: 20px;"></div>
    """,
    unsafe_allow_html=True)
